     ...
     <div class="row justify-content-center">
         <div class="col-md-12">
             <div class="card shadow-lg p-3 mb-5 bg-body border-0 rounded-4 mb-4">
                 ...
                 <!-- Header con título, buscador y botón centrado -->
                 <div class="row align-items-center mb-3">
                     ...
                     <div class="col-12 col-md-4 mb-2 mb-md-0 d-flex justify-content-center">
                         <input wire:model='keyWord' type="text" class="form-control"
                             placeholder="{{ __('teams.search_placeholder') }}" style="max-width: 250px;">
                     </div>

                     <div class="col-12 col-md-4 d-flex justify-content-center justify-content-md-end">
                         <button class="btn btn-info d-flex align-items-center gap-1" data-bs-toggle="modal"
                             data-bs-target="#createDataModal">
                             <i class="fa fa-plus"></i>
                             <span class="d-none d-md-inline">{{ __('teams.add_team') }}</span>
                             <span class="d-inline d-md-none">{{ __('teams.add_team') }}</span>
                         </button>
                     </div>
                 </div>
                                 ...
                                 @forelse($equipos as $row)
                                     <tr class="text-center text-md-start">
                                         ...
                                         <td class="d-flex align-items-center">
                                             <img src="{{ asset('storage/' . $row->logo) }}" alt="Escudo"
